...
/**
 * IPMEMS object with properties.
 * @author Dmitry Ovchinnikov
 */
public class IpmemsPropertized implements IpmemsPropertizedItf {
	/**
	 * Default constructor.
	 */
	public IpmemsPropertized() {
	}
	 ...
	 */
	public IpmemsPropertized(Map props) {
	...
	public <T> T get(Class<T> cl, String k, T d) {
		...
		try {
			...
			throw new IllegalArgumentException(k, x);
		}
	}
